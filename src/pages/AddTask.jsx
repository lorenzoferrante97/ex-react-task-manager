      ...
      <div className="w-full bg-neutral-100 px-3 py-8 flex justify-center items-center rounded-2xl">
        <form className="w-[60%] min-w-[480px] flex flex-col gap-4">
          <div className="flex flex-col w-full gap-2">
            ...
            <input className="bg-white rounded-lg min-h-12 px-4 py-1 min-w-[100%] border border-neutral-200/50 focus-visible:outline-2 focus-visible:outline-neutral-700 shadow-sm shadow-black/5" type="text" name="taskTitle" placeholder="Fare la spesa" />
          </div>
          <div className="flex flex-col w-full gap-2">
